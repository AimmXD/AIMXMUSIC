...
OWNER_USERNAME = getenv("OWNER_USERNAME", "cpr_yasir")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME", "ShizukaProBot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "Shizuka")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "NobitaXshizuka")
EVALOP = list(map(int, getenv("EVALOP", "6348268237").split()))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AimmXD/MUSICBOT",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/AimXbots")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/AimXsupport")
